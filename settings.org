...
** Key maps
    #+begin_src emacs-lisp
      ...
      (define-prefix-command 'my/bookmark-menu-map)
    #+end_src
...
*** Bookmark-menu
    #+begin_src emacs-lisp
      (define-key my/leader-map (kbd "b") 'my/bookmark-menu-map)

      (define-key my/bookmark-menu-map (kbd "l") 'bookmark-bmenu-list)
      (define-key my/bookmark-menu-map (kbd "a") 'bookmark-set)
      (define-key my/bookmark-menu-map (kbd "j") 'bookmark-jump)
    #+end_src
